...
func _ready():
	...
	damage_amount.text = "x%d" % MetaProgression.get_player_stat_multiplier("damage")
	health_amount.text = "x%d" % MetaProgression.get_player_stat_multiplier("health")
	movement_speed_amount.text = "x%d" % MetaProgression.get_player_stat_multiplier("movement")
